...
class Swiftpass extends \Think\Pay\Pay {
    ...
    public function buildRequestForm(\Think\Pay\PayVo $vo) {
        ...
        $_POST['body'] = $vo->getBody();
        $_POST['total_fee'] = $vo->getFee() * 100;
        $_POST['mch_create_ip'] = get_client_ip ();
        $_POST['sub_openid']=$vo->getOpenid();
        $_POST['callback_url']=$vo->getCallback();
        ...
        if($this->pay->call()){
            ...
            if($this->resHandler->isTenpaySign()){
                ...
                if($this->resHandler->getParameter('status') == 0 && $this->resHandler->getParameter('result_code') == 0){
                    ...
                    $url2['pay_info']  = $this->resHandler->getParameter('pay_info');
    ...
    protected function getSignVeryfy($param=array()) {
        ...
        if($this->resHandler->isTenpaySign()){
            if($this->resHandler->getParameter('status') == 0 && $this->resHandler->getParameter('result_code') == 0){
                ...
                $data['trade_no']     = $this->resHandler->getParameter('transaction_id');
                $this->setInfo($data);
