...
//            $Model  = $this->checkAttr($Model,$model['id']);
    ...
    */
    public function del_adv($model="",$ids=0){
        ...
        if(is_array($ids)){
            action_log('pl_del_adv','adv',UID,UID);
        }else{
            action_log('del_adv','adv',UID,UID);
        }
    ...
    */
    public function media_edit_adv($model="",$id=0){
        if(IS_POST){
            action_log('edit_media_adv','adv',UID,UID);
        }
    ...
    */
    public function add_media_adv($model=""){
        if(IS_POST){
            action_log('add_media_adv','adv',UID,UID);
        }
    ...
    *添加APP广告
    */
    public function add_app_adv($model=""){
        $this->base_add_adv($model,"app_adv_lists");
    }
