...
class LinksController extends ThinkController {
    ...
    public function add(){
        if(IS_POST){
            ...
            if($data){
                $Model->add($data);
                action_log('links_add','link',UID,UID);
    ...
    public function del($model = null, $ids=null)
    {
        ...
        if(is_array($_REQUEST['ids'])){
            action_log('pl_del_links','link',UID,UID);
        }else{
            action_log('del_links','link',UID,UID);
        }
    ...
    public function edit($id=0){
        ...
        if(IS_POST){
            ...
            if($data){
                ...
                action_log('links_edit','link',UID,UID);
