...
str;
        ...
        action_log('add_addons','addons',UID,UID);
    ...
    public function enable(){
        ...
        action_log('open_addons','addons',UID,UID);
        S('hooks', null);
    ...
    public function saveConfig(){
        ...
        if($flag !== false){
            action_log('edit_addons','addons',UID,UID);
    ...
    public function delhook($id){
        if(M('Hooks')->delete($id) !== false){
            action_log('del_hook','hook',UID,UID);
            $this->success('删除成功');
        }else{
            $this->error('删除失败');
        }
    ...
    public function updateHook(){
        ...
        if($data){
            if($data['id']){
                ...
                if($flag !== false){
                    S('hooks', null);
                    action_log('edit_hook','hook',UID,UID);
                ...
                if($flag){
                    S('hooks', null);
                    action_log('add_hook','hook',UID,UID);
