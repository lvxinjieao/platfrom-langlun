...
class GameTypeModel extends Model{
    ...
    protected $_validate = array(
        array('type_name',  'require', '游戏类型名称不能为空',         self::MUST_VALIDATE,  'regex',  self::MODEL_BOTH),
        array('type_name',  '1,30',    '游戏类型名称不能超过30个字符', self::VALUE_VALIDATE, 'length', self::MODEL_BOTH),
