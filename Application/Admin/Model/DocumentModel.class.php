...
class DocumentModel extends Model{
    ...
    protected $_validate = array(
        ...
        array('deadline', 'checkDeadline', '创建日期需要小于结束日期', self::VALUE_VALIDATE, 'callback', self::MODEL_BOTH),
    );
    ...
    protected function checkDeadline(){
        ...
        if(!empty(I('deadline',0)) && strtotime(I('create_time')) > strtotime(I('deadline'))){
            $this->error = '截至时间不能小于创建时间！';
            return false;
        }
    }
