...
class UserEvent extends BaseEvent {
    ...
    public function user_join($model = null, $p = 0){
        ...
        $row    = get_list_row();//empty($model['list_row']) ? 15 : $model['list_row'];
  ...
  public function user_join_($model = null, $p = 0){
        ...
        $row    = get_list_row();// empty($model['list_row']) ? 20 : $model['list_row'];
        // $row = 1;
        //读取模型数据列表
        $name = $model['m_name'];
        $data = M($name,"tab_")
  ...
  public function user_join__($model = null, $p = 0){
        ...
        $row    = get_list_row();//empty($model['list_row']) ? 10 : 3;
