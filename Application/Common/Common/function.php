...
function msubstr1($str, $start=0, $length, $charset="utf-8", $suffix=true) {
    ...
    return $suffix && strlen($slice) > $length  ? $slice.'...' : $slice;
}
...
//如果字符长度没有超过限制 则不加上。。。
function msubstr4($str, $start=0, $length, $charset="utf-8") {
    $slice = mb_substr($str, $start, $length, $charset);
    return $slice;
}
