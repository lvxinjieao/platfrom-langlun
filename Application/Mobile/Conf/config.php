 ...
 * 所有除开系统级别的前台配置
 */
 define('URL_CALLBACK', 'http://'.$_SERVER['HTTP_HOST'].'/mobile.php?s=/Subscriber/callback/type/');

return array(

    // 预先加载的标签库
    'TAGLIB_PRE_LOAD'     =>    'OT\\TagLib\\Article,OT\\TagLib\\Game,OT\\TagLib\\Advert,OT\\TagLib\\Gift,OT\\TagLib\\Think',
    ...
    'THINK_SDK_BAIDU' => array(
        ...
        'CALLBACK'   => 'http://'.$_SERVER['HTTP_HOST'].'/mobile.php/Subscriber/callback/type/baidu',
    ),
);
