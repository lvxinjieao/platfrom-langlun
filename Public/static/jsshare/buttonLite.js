...
BSHARE_WEB_HOST = "http://www.bshare.cn"; (function(e, g) {
    ...
    if (! (h.count > 0)) {
        ...
        a.start = function() {
            d.loadEngine && (d.loadEngine(e), a.loadOptions(), a.international(function() {
                if (!a.completed) {
                    ...
                    a.createBox();
                    b.mdiv >= 0 && c.type != 15 && d.loadScript(a.jsBasePath + "components/bsMore.js?v=20161227");
        ...
        a.init = function() {
            ...
            d.loadScript(a.jsBasePath + "engines/bs-engine.js?v=20161227", a.start)
        };
